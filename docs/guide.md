...
Présentation rapide du projet : voir le [README](../README.md). Format des
données attendues : voir le [contrat d'API](api.md).

- [Architecture](#architecture)
- [Les cas d'affichage](#les-cas-daffichage)
- [Configuration](#configuration-env)
- [Lancer en développement](#lancer-en-développement-maclinux-sans-pi)
- [Déployer sur le Raspberry Pi](#déployer-sur-le-raspberry-pi)
- [Makefile](#makefile)
...
| `make demo-gif` | Régénère depuis `docs/demo.json` l'aperçu animé du README (`docs/demo.gif`) et l'image d'aperçu de lien GitHub (`docs/social-preview.png`, à envoyer à la main dans Settings → Social preview) |
...
│   └── README.md
├── docs/
│   ├── guide.md           # cette documentation technique
│   ├── api.md             # contrat d'API
